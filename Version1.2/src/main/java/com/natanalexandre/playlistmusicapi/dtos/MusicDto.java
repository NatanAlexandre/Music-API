...
public class MusicDto {
    ...
    public MusicDto(String musicName, String musicVersion, String artistName, boolean feat, List<String> otherArtists,
    ...
    public void setOtherArtists(List<String> otherArtists) {
        this.otherArtists = otherArtists;
    }
